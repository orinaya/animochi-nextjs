...
function getVariant(variant: ButtonVariant, color: ThemeColor, disabled: boolean): string {
  const baseClasses =
    "px-6 py-3 text-sm font-semibold rounded-2xl transition-all duration-300 border focus:outline-none focus:ring-2 focus:ring-offset-2 transform hover:scale-105 active:scale-95"
  ...
  const styleMap: Record<ThemeColor, Record<ButtonVariant, string>> = {
    blueberry: {
      primary: `${baseClasses} bg-blueberry-950 hover:bg-blueberry-800 text-white border-blueberry-950 focus:ring-blueberry-950`,
      secondary: `${baseClasses} bg-latte-25 hover:bg-latte-50 text-blueberry-950 border-latte-100 focus:ring-blueberry-950`,
      ghost: `${baseClasses} bg-transparent hover:bg-latte-25 text-blueberry-950 border-transparent focus:ring-blueberry-950`,
    ...
    strawberry: {
      ...
      ghost: `${baseClasses} bg-transparent hover:bg-strawberry-100 text-strawberry-600 border-transparent focus:ring-strawberry-400`,
    ...
    peach: {
      ...
      ghost: `${baseClasses} bg-transparent hover:bg-peach-50 text-peach-700 border-transparent focus:ring-peach-100`,
    ...
    latte: {
      ...
      ghost: `${baseClasses} bg-transparent hover:bg-latte-100 text-latte-800 border-transparent focus:ring-latte-50`,
